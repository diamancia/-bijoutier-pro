...
const SEED_DATA = {
  ...
  commandes: [
    ...
    { id: 'cmd_004', client_id: 'cli_001', type: 'Bracelet', poids_or_g: 2.0, purete: '18K', pierres: 'Sans pierres', taille: '18cm', date_depot_or: '2026-06-05', date_livraison_prevue: '2026-06-15', date_livraison_effective: '2026-06-14', statut: 'livree', tarif_prestation: 120, cours_depot: 639, type_metal: 'or', prix_modele_3d_mad: 0, honoraires_mad: 120, or_prete_g: 0, piece_id: 'pie_003', notes: '', created_at: '2026-06-05T09:00:00Z' },
    { id: 'cmd_005', client_id: 'cli_002', type: 'Boucles', poids_or_g: 1.5, purete: '18K', pierres: 'Zircone', taille: '', date_depot_or: '2026-06-01', date_livraison_prevue: '2026-06-10', date_livraison_effective: '2026-06-09', statut: 'livree', tarif_prestation: 100, cours_depot: 638, notes: '', created_at: '2026-06-01T08:30:00Z' },
    ...
    { id: 'cmd_007', client_id: 'cli_004', type: 'Collier', poids_or_g: 3.2, purete: '22K', pierres: 'Sans pierres', taille: '40cm', date_depot_or: '2026-06-08', date_livraison_prevue: '2026-06-18', date_livraison_effective: '2026-06-17', statut: 'livree', tarif_prestation: 110, cours_depot: 640, notes: '', created_at: '2026-06-08T14:00:00Z' },
    { id: 'cmd_008', client_id: 'cli_004', type: 'Bracelet', poids_or_g: 4.0, purete: '18K', pierres: 'Naturelles', taille: '17cm', date_depot_or: '2026-06-02', date_livraison_prevue: '2026-06-12', date_livraison_effective: '2026-06-11', statut: 'livree', tarif_prestation: 110, cours_depot: 637, notes: '', created_at: '2026-06-02T09:00:00Z' },
  ],

  stock: {
    propre: [
      { id: 'stp_001', poids_g: 45.0, purete: '24K', source: 'Achat Al Waha', date: '2026-06-19', notes: 'Stock principal' },
      { id: 'stp_002', poids_g: 8.2, purete: '24K', source: 'Balayure incinération', date: '2026-06-19', notes: 'Récupéré atelier' },
    ],
    client: [
      { id: 'stc_001', client_id: 'cli_001', commande_id: 'cmd_001', poids_g: 3.5, purete: '18K', date_depot: '2026-06-12', date_sortie: null },
      { id: 'stc_002', client_id: 'cli_002', commande_id: 'cmd_002', poids_g: 4.2, purete: '18K', date_depot: '2026-06-10', date_sortie: null },
      { id: 'stc_003', client_id: 'cli_003', commande_id: 'cmd_003', poids_g: 6.0, purete: '18K', date_depot: '2026-06-15', date_sortie: null },
      { id: 'stc_004', client_id: 'cli_004', commande_id: 'cmd_006', poids_g: 2.8, purete: '18K', date_depot: '2026-06-14', date_sortie: null },
    ],
    atelier: [
